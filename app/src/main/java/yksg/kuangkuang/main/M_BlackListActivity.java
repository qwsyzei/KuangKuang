 ...
 * 黑名单界面
 */
public class M_BlackListActivity extends BaseActivity implements ObservableScrollView.ScrollViewListener{
    ...
    private void initView() {
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                scrollView.setScrollViewListener(M_BlackListActivity.this);
            }
        });
        tlist = new ArrayList<>();
        listView = (SelfListView) findViewById(R.id.listview_blacklist);
