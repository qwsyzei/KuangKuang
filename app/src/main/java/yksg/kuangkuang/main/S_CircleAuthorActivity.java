 ...
 * 圈子作者主页
 */
public class S_CircleAuthorActivity extends BaseActivity implements PullToRefresh123View.OnFooterRefreshListener,View.OnClickListener,ObservableScrollView.ScrollViewListener{
    ...
    String follow_state,followed_number;
    ...
    private void initView() {
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                scrollView.setScrollViewListener(S_CircleAuthorActivity.this);
            }
        });
        ...
        followed_number=intent.getStringExtra("followed_number");
        sList = new ArrayList<>();
        ...
        if (followed_number.contains(".0")){
            tv_followed_number.setText("已有"+followed_number.replace(".0", "") + "人关注");
        }else{
...
//            ImageLoader.getInstance().displayImage(Consts.host + "/" + picture_head, im_pic_head);
    ...
    private void getWordList() {
        ...
        if (http == null) http = new MyHTTP(S_CircleAuthorActivity.this);
    ...
    public void onFooterRefresh(PullToRefresh123View view) {
        mPullToRefreshView.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                loadDataFrom();
                ToastUtil.show(S_CircleAuthorActivity.this, getString(R.string.load_more));
            }
        }, 3000);
    }
    ...
    public void updateData() {
        if (jtype.equals(JSONHandler.JTYPE_MYWORD_LIST)) {
            ...
            if (os.size() == 0) {
                ToastUtil.show(S_CircleAuthorActivity.this, getString(R.string.no_more_data));
                return;
            }
            addTrades("bottom", os);
            if (curTradesSize == 0) {
            ...
            ToastUtil.show(S_CircleAuthorActivity.this, getString(R.string.add_follows_success));
            im_follow.setImageResource(R.mipmap.followed_gray);
            follow_state="1";
        }
    }
            ...
            case R.id.im_s_author_follow:
                ...
                if (isSigned()) {
                    if (author_id.equals(DataCenter.getMember_id())) {
                        ToastUtil.show(S_CircleAuthorActivity.this, getString(R.string.cannot_add_follow_self));
                    } else {
                        gotoFollow();
                    }
                } else {
                    ToastUtil.show(S_CircleAuthorActivity.this, getString(R.string.not_login));
                }
                break;
        }
    }
