package yksg.kuangkuang.testpic;
...
import yksg.kuangkuang.photoview.PhotoViewAttacher;
...
public class PhotoActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void Exit_Dialog() {
        exitDialog = new ExitDialog(PhotoActivity.this, R.style.MyDialogStyle, R.layout.dialog_exit);
        exitDialog.show();
        tv_dialog_title = (TextView) exitDialog.findViewById(R.id.dialog_exit_title);
        tv_dialog_title.setText(getString(R.string.if_delete_picture));
        ...
        switch (view.getId()) {
            case R.id.exit_yes:
                if (listViews.size() == 1) {
                    ...
                    Bimp.drr = drr;
                    Bimp.max = max;
                    FileUtils.delFile(del.get(0) + ".JPEG");
                    exitDialog.dismiss();
                }
                break;
            case R.id.exit_no:
