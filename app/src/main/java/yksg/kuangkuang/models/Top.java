...
public class Top implements Serializable {
    ...
    public Top getFromJSONObjectItem(JSONObject object) {
        try {
    ...
    public Top getauthorInfo(String nickname, String picture_son, String signature, String describe_son, String follow_state,String is_like,String is_collect,String picture_url) {
        try {
