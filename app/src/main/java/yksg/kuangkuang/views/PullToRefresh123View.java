...
/***
 * 加载方法 与PullToRefresh123View类似，但不能下滑刷新，只能上拉加载更多

 */
public class PullToRefresh123View extends LinearLayout {
    ...
    public PullToRefresh123View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PullToRefresh123View(Context context) {
        super(context);
        init();
    }
...
//                } else
    ...
    private void footerPrepareToRefresh(int deltaY) {
        ...
        if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
            ...
            mFooterImageView.clearAnimation();
            mFooterImageView.startAnimation(mFlipAnimation);
            mFooterTextView.setText("上滑加载更多");
    ...
    public interface OnHeaderRefreshListener {
        public void onHeaderRefresh(PullToRefresh123View view);
    }
}
