...
public class MyRadioGroup extends LinearLayout {
            ...
            ((RadioButton) child).setOnTouchListener(new OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if(mOnCheckedChangeListener != null){
                        mOnCheckedChangeListener.onCheckedChanged(yksg.kuangkuang.views.MyRadioGroup.this, child.getId());
                    }
                    return true;
                }
            });
                ...
                if (view instanceof RadioButton) {
                    ...
                    ((RadioButton) button).setOnTouchListener(new OnTouchListener() {
                        ...
                        public boolean onTouch(View v, MotionEvent event) {
                            ...
                            if(mOnCheckedChangeListener != null){
                                mOnCheckedChangeListener.onCheckedChanged(yksg.kuangkuang.views.MyRadioGroup.this, button.getId());
                            }
                            return true;
                        }
                    });
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new yksg.kuangkuang.views.MyRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    public interface OnCheckedChangeListener {
        ...
        public void onCheckedChanged(yksg.kuangkuang.views.MyRadioGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == yksg.kuangkuang.views.MyRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
